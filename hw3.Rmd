...
auc_logistic <- multiclass.roc(test$Class,prob) 
...
#  HW3   HW3      HW3     K-Fold cross Validation 
...
#Based on the above  information we continued our analysis using the most important 18 features. 
...
#To solve the problem of imbalance we assigned specific weight for each group to reverse the imbalance in our data set. Considering we have 3 groups so #we multiply each with 1/3 to reverse the imbalance. 
